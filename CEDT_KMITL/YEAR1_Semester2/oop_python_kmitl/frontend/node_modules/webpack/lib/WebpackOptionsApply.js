...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/itswatthachai/.vscode/extensions/wallabyjs.console-ninja-1.0.360/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20aeb0b0f6851571fc37dbVEtaAUwAXAMPBglUVgAHBVcDXVtY', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/itswatthachai/.vscode/extensions/wallabyjs.console-ninja-1.0.360/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20aeb0b0f6851571fc37dbVEtaAUwAXAMPBglUVgAHBVcDXVtY', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

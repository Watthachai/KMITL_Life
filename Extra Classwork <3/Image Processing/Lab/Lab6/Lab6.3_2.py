...
# Add Dense layers
# Layer 1 with 512 nodes and ReLU activation
x = Dense(512, activation='relu')(x)

# Layer 2 with 256 nodes and ReLU activation
...
# Freeze layers from the base MobileNet model up to index 60
...
eps = 100  # Adjust the number of epochs
...
# # confusion_matrix(model, test_generator[0][0], y_true, cmap=plt.cm.Blues)
...
target_names = ['class_0', 'class_1', 'class_2']  # Replace with your class labels
